...
//密码
function focus_pwd() { 
   var resultObj=document.getElementById('result_pwd'); 
   resultObj.innerHTML="6位以上的非特殊字符"; 
   resultObj.style.color="black"; 
   document.form.pwd.style="border:1px solid red"; 
}  
function blur_pwd() {  
    var resultObj=document.getElementById('result_pwd');  
    var pre=document.form.pwd.value; 
    var reg=/^\w{6,}$/; 
    if (pre=='') { 
...
function blur_repwd() { 
    ...
    if (pre=='') { 
	    ...
	    resultObj.style.color="red"; 
	    return false; 
    }else if(document.form.pwd.value!=document.form.repwd.value){ 
